 ...
 *
 * Receives data from TradingView Pine Script alerts
 * Merges into public/morning_brief.json via GitHub API
 *
 * Each alert sends: { "source": "...", ...values }
 * Sources: vol_pace | vol_pace_iwo | svp | strat_iwm_1d | strat_iwo_1d | strat_iwm_1h | strat_iwo_1h | cvd | pmh_pml
 */
...
function mergeData(existing, source, payload) {
  ...
  // Determine vol state from IWM + IWO
...
module.exports = async function handler(req, res) {
  ...
  console.log(`TradingView webhook received: source=${source}`, payload);
